...
export default function Mission() {
    return (
        <section className="relative p-4 bg-background">
            <div className="relative mx-auto container bg-secondary p-4 py-20 md:px-12 lg:px-16 rounded-2xl grid md:grid-cols-7 gap-12">
                <div className="md:col-span-4">
                    <FadeUp>
                        <h2 className="h2 text-left text-2xl md:text-3xl"><span className="text-primary">
